...
export default function AdminLoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen" style={{ backgroundColor: '#ffffff', padding: '1rem' }}>
      <div style={{ maxWidth: '400px', width: '100%', padding: '2.5rem 1.5rem', border: '1px solid #eaeaea', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', textAlign: 'center' }}>
        <img
